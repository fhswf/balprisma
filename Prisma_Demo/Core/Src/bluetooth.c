...
uint8_t bt_init()
{
	...
	HAL_Delay(100);
	HAL_GPIO_WritePin(BT_PWR_N_GPIO_Port, BT_PWR_N_Pin, GPIO_PIN_RESET);	// active low
...
//#endif
	// Back to normal mode
	HAL_GPIO_WritePin(BT_PWR_N_GPIO_Port, BT_PWR_N_Pin, GPIO_PIN_SET); 	// active low
	HAL_GPIO_WritePin(BT_EN_GPIO_Port, BT_EN_Pin, GPIO_PIN_RESET);
	HAL_Delay(200);
	HAL_GPIO_WritePin(BT_PWR_N_GPIO_Port, BT_PWR_N_Pin, GPIO_PIN_RESET);  	// active low
	bt_ok_g = BT_READY;
