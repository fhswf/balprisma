...
extern TIM_HandleTypeDef htim2;			//Timer 2 -> LED-Ring data
extern TIM_HandleTypeDef htim4;			//Timer 4 -> LED-Ring status update
...
void ledring_update(void)
{
	...
	// start DMA transfer
	HAL_TIM_PWM_Start_DMA(&htim2, TIM_CHANNEL_3, (uint32_t *)pwm_data, 24*LEDRING_CNT+50);
