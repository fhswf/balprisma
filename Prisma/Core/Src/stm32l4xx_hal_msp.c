...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC3     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = MOT_SENSE_Pin|BAT1_SENSE_Pin|BAT2_SENSE_Pin|BAT3_SENSE_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOC, MOT_SENSE_Pin|BAT1_SENSE_Pin|BAT2_SENSE_Pin|BAT3_SENSE_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = MOT1_EN_Pin|MOT2_EN_Pin|MOT3_EN_Pin;
